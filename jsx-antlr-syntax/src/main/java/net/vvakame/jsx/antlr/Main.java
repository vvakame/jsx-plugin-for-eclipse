     ...
     */
    	...
    	public static void main(String[] args)
        {
            try
            {
                ...
                {
                    System.err.println("Usage: java -jar jsx-antlr-syntax-0.0.1-jar-with-dependencies.jar <directory | filename.jsx>");
                }
            }
            catch (Exception ex)
            {
        ...
        public static void parseSource(String source) throws Exception
        {
            ...
            try
            {
                ...
                programFile_return psrReturn = parser.programFile();
