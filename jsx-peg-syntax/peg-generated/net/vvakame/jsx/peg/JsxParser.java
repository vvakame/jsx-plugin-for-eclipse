//=========================================================================
//
//  This file was generated by Mouse 1.5 at 2012-09-06 06:24:09 GMT
//  from grammar
...
public class JsxParser extends mouse.runtime.ParserMemo
{
  ...
  private boolean oClassDef_0()
    {
      ...
      if (!objectTypeDeclaration()) return rejectInner();
      return acceptInner();
    }
  ...
  private boolean nullLiteral_0()
    {
      ...
      if (!typeDeclaration()) return rejectInner();
      return acceptInner();
    }
  ...
  //-------------------------------------------------------------------
  //  hashLiteral_1 = COLON typeDeclaration
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  hashLiteral_2 = COMMA (ident / numberLiteral / string) COLON
  //    assignExpr
  //-------------------------------------------------------------------
  private boolean hashLiteral_2()
    {
      if (savedInner(hashLiteral_2)) return reuseInner();
      if (!COMMA()) return rejectInner();
      if (!ident()
       && !numberLiteral()
       && !string()
  ...
  private boolean string()
    {
      ...
      if (doubleQuoted()) return accept();
      if (singleQuoted()) return accept();
      return reject();
    }
  ...
  final Cache hashLiteral_1 = new Cache("hashLiteral_1"); // COLON typeDeclaration
  final Cache hashLiteral_2 = new Cache("hashLiteral_2"); // COMMA (ident / numberLiteral / string) COLON assignExpr
  ...
  Cache[] cacheList =
  {
    ...
    oClassDef,oInterfaceDef,oMixinDef,objectTypeDeclaration,
    memberDefinition,IDENT,formalTypeArguments,typeDeclaration,
    assignExpr,ident,nullLiteral,arrayLiteral,hashLiteral,
    functionArgumentsExpr,argsExpr,string,doubleQuoted,singleQuoted,
    regexp,numberLiteral,decimalIntegerLiteral,exponentPart,
    numberLiteral2,integerLiteral,multilineComment,singlelineComment,
    spacing,space,NOT,NOTEQ,SUR,SUREEQ,AND,BITAND,BITANDEQ,LPAR,RPAR,
    MUL,MULEQ,ADD,INC,ADDEQ,COMMA,SUB,DEC,SUBEQ,ARROW,DOT,ARGS,DIV,
    DIVEQ,COLON,SEMI,LT,LSHIFT,LSHIFTEQ,LTEQ,ASSIGN,EQ,GT,GTEQ,COND,
    LBRA,RBRA,XOR,XOREQ,LWING,BITOR,BITOREQ,OR,RWING,MAYBEUNDEFINED,
    NULLABLE,ABSTRACT,AS,ASSERT,BOOLEAN,BREAK,CASE,CATCH,CLASS,CONST,
    CONSTRUCTOR,CONTINUE,DEBUGGER,DEFAULT,DELETE,DO,ELSE,EXTENDS,
    FALSE,FINAL,FINALLY,FOR,FROM,FUNCTION,IF,IMPLEMENTS,IMPORT,IN,
    INLINE,INSTANCEOF,INT,INTERFACE,INTO,LOG,MIXIN,NATIVE,NEW,NULL,
    NUMBER,OVERRIDE,RETURN,STATIC,STRING,SUPER,SWITCH,THIS,THROW,TRUE,
    ...
    oClassDef_2,ident_0,nullLiteral_0,arrayLiteral_0,arrayLiteral_1,
    hashLiteral_0,hashLiteral_1,hashLiteral_2,functionArgumentsExpr_0,
    functionArgumentsExpr_1,functionArgumentsExpr_2,
    functionArgumentsExpr_3,argsExpr_0,argsExpr_1,doubleQuoted_0,
    doubleQuoted_1,singleQuoted_0,singleQuoted_1,regexp_0,regexp_1,
    regexp_2,decimalIntegerLiteral_0,numberLiteral2_0,
    numberLiteral2_1,numberLiteral2_2,integerLiteral_0,
